 ...
 * Generated at: 2019-09-03 09:40:46 UTC
...
public final class boardListVer2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/common/JEasyUICommon.jsp", Long.valueOf(1567067907013L));
  }
...
//총레코드 갯수
	...
	path.append("/");
      ...
      out.write("    \t//cmm_window_popup(\"test.mo?crud=boardDetail&bm_no=\"+p_bmno,\"700\",\"450\",\"read\");\r\n");
      ...
      out.write("\t\t//alert(\"rows.size():\"+rows.length);\r\n");
      out.write("\t\t$.messager.confirm('Confirm','정말삭제하시겠습니까?',function(r){\r\n");
      out.write("\t\t\tif(r){\r\n");
      ...
      out.write("\t\t\t\t\t//필드명은 myBatis의 Map을 사용하였으므로 반드시 대문자로 처리함.\r\n");
      out.write("\t\t\t\t\tbsfileArr.push(rows[j].BS_FILE2);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t//배열에 담긴 정보 출력해보기\r\n");
      out.write("\t\t \t\tfor(var i=0;i<rows.length;i++){\r\n");
      out.write("\t\t \t\t\t//맨 마지막에 붙는 값뒤에는 콤마를 붙일 필요가 없음.\r\n");
      out.write("\t\t \t\t\tif(i==(rows.length-1)){\r\n");
      out.write("\t\t \t\t\t\tvbmnos +=bmnoArr[i];\r\n");
      out.write("\t\t \t\t\t}\r\n");
      out.write("\t\t\t\t\t//뒤에 값이 더 있을 경우에는 콤마를 붙여 줍니다.\r\n");
      out.write("\t\t\t\t\t//자바코드에서 StringTokenizer로 문자열을 썰때 ,를 기준으로 \r\n");
      out.write("\t\t\t\t\t//썰어서 담으니까 맨 끝에 콤마가 있으면 실제 있는값보다 1개가 더 생김\r\n");
      out.write("\t\t \t\t\telse{\r\n");
      out.write("\t\t \t\t\t\tvbmnos +=bmnoArr[i]+\",\";\r\n");
      out.write("\t\t \t\t\t}\r\n");
      out.write("\t\t\t\t}//////////////////////end of for\r\n");
      out.write("\t\t\t\t//로우의 수는 고정이지만 첨부파일은 있는 경우도 있고 없는 경우도 있으므로\r\n");
      out.write("\t\t\t\t//똑같이 반복되어서는 안될 것임.\r\n");
      out.write("\t\t\t\t//배열에 담기는  글번호의 갯수와 첨부 파일의 갯수가 다를 수 있다는 것임.\r\n");
      ...
      out.write("\t\t\t\t\turl:\"test.mo?crud=boardList&cb_search=\"\r\n");
      out.write("\t\t\t\t\t\t\t    +user_combo+\"&keyword=\"+$(\"#keyword\").val()\r\n");
      out.write("\t\t\t\t});\t\t\t    \r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});//////////////////end of ready(DOM 구성이 끝났을 때-브라우저가)\t\r\n");
      out.write("</script>\r\n");
      out.write("<!-- \r\n");
      out.write("======================== [[글목록 화면 시작]] =========================\r\n");
      ...
      out.write(" -->\r\n");
      out.write(" <table id=\"dg_board\" title=\"글목록\" style=\"width:950px;height:500px\" class=\"easyui-datagrid\" data-options=\"toolbar:'#tb_search,#tb_board',footer:'#pn_board'\">\r\n");
      out.write(" \t<!--헤더부분 추가 -->\r\n");
      out.write(" \t<thead>\r\n");
      out.write("\t \t<tr>\r\n");
      ...
      out.write("            <th data-options=\"field:'BS_FILE2',width:'280px',hidden:'true'\">&nbsp;</th>\r\n");
...
//		for(int i=0;i<size;i++){
      ...
      out.write(" \t\t<tr>\r\n");
      out.write("<!-- \r\n");
      out.write("header영역에서 hidden으로 처리해서 화면상에는 보이지 않지만 datagrid안에는 값이 들어있는 상태\r\n");
      out.write("여야 함.\r\n");
	...
	if(Integer.parseInt(rMap.get("BM_POS").toString()) > 0 ){
      ...
      out.write("이것만 보더라도 서버에서 변경된 결과값들이 화면에 왜 즉시 반영될 수 없는 구조인지 확인할 수 있겠다.\r\n");
      out.write("자바 스크립트에서 값을 넘길 때는 반드시 싱글 혹은 더블 쿼테이션을 붙여야 변수로 취급 받지 않는다.\r\n");
      ...
      out.write(" <table border=\"1\" borderColor=\"red\" style=\"width:950px;height:20px\">\r\n");
      out.write(" \t<tr>\r\n");
	...
	PageBar pb = new PageBar(numPerPage,tot,nowPage,pagePath);
 	...
 	out.print(pagination);
      ...
      out.write("==================================================================\r\n");
      out.write("-->\r\n");
      out.write("<div id=\"dlg_boardAdd\" title=\"글쓰기\" class=\"easyui-dialog\" style=\"width:600px;height:400px;padding:10px\" data-options=\"closed:'true',modal:'true',footer:'#tbar_boardAdd'\">\t\r\n");
      out.write("<!-- \r\n");
