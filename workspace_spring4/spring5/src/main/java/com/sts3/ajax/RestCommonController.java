...
public class RestCommonController {
	...
	@GetMapping(value="customerInfo.do",produces="text/plain;charset=UTF-8")
	public String customerInfo(@ModelAttribute("mem_tel") String mem_tel) {
		logger.info("사용자가 입력한 전번 : "+mem_tel);
		List<Map<String,Object>> cusList = new ArrayList<>();
		Map<String,Object> rMap = new HashMap<>();
		rMap.put("mem_name","이순신");
		rMap.put("mem_addr","서울시 마포구 공덕동");
