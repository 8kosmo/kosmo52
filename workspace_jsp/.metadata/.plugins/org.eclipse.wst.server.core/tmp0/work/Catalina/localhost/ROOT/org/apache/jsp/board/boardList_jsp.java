 ...
 * Generated at: 2019-08-09 03:03:23 UTC
...
//총레코드 갯수
	...
	out.print("tot:"+tot);
      ...
      out.write("\t화면은 html로 그리지만 조회된 결과를 html에 반영하기 위해 DOM을 조작하는 방법에 대해 \r\n");
      out.write("\t말 할 수 있다.\r\n");
      ...
      out.write("\t여러가지 경우에 수에 대해 미리 생각해 봄으로써 UI솔루션이 javascript기반이거나 xml기반 혹은\r\n");
      out.write("\t안드로이드에서 적용할 수 있도록 실습해 볼 것.\r\n");
      out.write("*/\r\n");
      out.write("\tfunction boardList(){//태그 조작(DOM조작 - json:DefaultTableModel datagrid: JTable)\r\n");
      out.write("\t\t//alert(\"boardList호출 성공\");\r\n");
      ...
      out.write("\t\t        {field:'BS_FILE',title:'첨부파일',width:170,align:'left'},\r\n");
      out.write("\t\t        {field:'BM_DATE',title:'조회수',width:170,align:'center'}\r\n");
      out.write("\t\t    ]]\r\n");
      ...
      out.write("\t\t   \t\t\t//너 제목을 더블클릭했니?\r\n");
      out.write("\t\t   \t\t\tif(\"BM_TITLE\" == field){\r\n");
      out.write("\t\t   \t\t\t\t//alert(\"제목\"+value);\r\n");
      out.write("\t\t   \t\t\t\tcmm_window_popup(\"test.mo?crud=boardDetail&bm_no=\"+g_no,\"700\",\"450\",\"read\");\r\n");
      ...
      out.write(" -->\r\n");
      out.write(" <table id=\"dg_board\" title=\"글목록\" style=\"width:950px;height:400px\" class=\"easyui-datagrid\" data-options=\"toolbar:'#tb_search,#tb_board',footer:'#pn_board'\">\r\n");
      out.write(" </table>\r\n");
