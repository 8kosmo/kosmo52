 ...
 * 예를 들면  setValueAt(값,로우 index,컬럼 index)
 *        getValueAt(로우 index,컬럼 index)
 * 또한 DefaultTableModel은 특정셀이 편집될 수 있는지 각 열의 데이터 타입은 무엇인지를 얻어
 * 내는 역할도 함.
 ...
 */
	...
	/*
	 * DefaultTableCellRenderer는 TableCellRender 인터페이스를 구현한 디폴트
	 * 클래스이다.
